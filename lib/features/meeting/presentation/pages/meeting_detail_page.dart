...
import 'package:sbm_v18/features/meeting/presentation/pages/voice_separationPage.dart';
    ...
    return BlocConsumer<MeetingCubit, MeetingState>(
              ...
              builder:
                  (context2) => BlocProvider.value(
                    ...
                    child: TranslationPage(
                      transcribedText:
                          state.transcribedText ?? 'No transcription available',
                    ),
                  ),
            ),
          );
          ...
          Navigator.push(
            ...
            MaterialPageRoute(
              builder:
                  (context2) => BlocProvider.value(
                    value: BlocProvider.of<MeetingCubit>(context),
                    child: VoiceSeparationPage(
                      transcripts: state.voiceSeparation ?? [],
                    ),
                  ),
            ),
          );
      ...
      builder: (context, state) {
        return Scaffold(
          ...
          appBar: AppBar(
            title: Text(meeting.title, style: TextStyle(color: AppColor.white)),
                ...
                children: [
                  _InfoCard(
                    ...
                    children: [
                      ...
                      _InfoRow(
                        label: 'Start Time',
                        value: meeting.startTime.toLocal().toString(),
                      ),
                      _InfoRow(
                        label: 'Room ID',
                        value: meeting.roomId.toString(),
                      ),
                      _InfoRow(
                        label: 'Ask to Join',
                        value: meeting.askToJoin == 1 ? 'Yes' : 'No',
                      ),
                    ],
                  ),
                      ...
                      ListTile(
                        ...
                        subtitle: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Birthday: ${meeting.creator.birthday.toLocal().toIso8601String().split("T").first}',
                            ),
                                    ...
                                    child: ListTile(
                                      ...
                                      trailing: Row(
                                        ...
                                        children: [
                                          ...
                                          if (state.isLoading ==
                                              MeetingsIsLoading.voiceSeparation)
                                            const SizedBox(
                                              height: 20,
                                              width: 20,
                                              child: CircularProgressIndicator(
