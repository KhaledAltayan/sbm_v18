          ...
          listener: (context, state) {
            if (state.isSuccess == AuthIsSuccess.searchSuccess &&
              ...
              if (!invitedEmails.contains(email)) {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(content: Text('User "${state.searchedUser!.user.firstName}" invited')),
                );
              } else {
                ScaffoldMessenger.of(context).showSnackBar(
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(content: Text(state.failure?.message ?? 'User not found')),
              );
            }
          },
        ),
        ...
        body: Padding(
          ...
          child: Column(
            children: [
              ...
              if (context.watch<AuthCubit>().state.isLoading == AuthIsLoading.searchingUser)
                const Padding(
